...
**English summary:** SugarEDA is an open-source Tauri 2 schematic capture and SPICE simulation workbench. It includes tabbed multi-sheet projects, project-wide ERC, active-sheet SPICE simulation, structured electrical preflight checks, atomic project files, crash recovery, large-sheet performance coverage, and real desktop WebDriver smoke tests.
